...
public class AlgorithmFunction {
	 ...
	 */
	public static List<Network> strongestSignal(List<Network> database,int k) {
		return database
			.stream()
			.parallel()
	...
	/*Get average Network*/
	public static Network WeightedAverage(List<Network> listMAC) {
		/*List of 3 sorted database by signal*/
		List<Network> data = strongestSignal(listMAC, 3);
